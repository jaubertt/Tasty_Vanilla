...
public class WhiteCurrantBerryBushBlock extends SweetBerryBushBlock {
    ...
    public WhiteCurrantBerryBushBlock(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        if (age > 1) {
            ...
            Block.popResource(level, pos, new ItemStack(ModItems.BERRY_WHITE_CURRANT_BERRIES, randomDropAmount + (isMaxAge ? 1 : 0)));
